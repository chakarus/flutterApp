...
class DetailsPage extends StatefulWidget {
  ...
  DetailsPage({this.image ,this.name,this.price,this.bigDesc,this.litleDesc}) ;
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          provider.ajouterAuPanier(ProduitModel(image: widget.image, name: widget.name, price: widget.price, quantity: quantity));
